...
class FirebaseAuthService {
     ...
     */
    async registerWithEmail(email, password, displayName, subscribeNewsletter = true) {
        try {
            ...
            await this.db.collection('users').doc(user.uid).set({
                ...
                newsletterDate: subscribeNewsletter ? firebase.firestore.FieldValue.serverTimestamp() : null
            });
    ...
    async getNewsletterStatus() {
        ...
        try {
            ...
            return data?.newsletterSubscribed || false;
        } catch (error) {
            console.error('Error obteniendo estado newsletter:', error);
            return false;
        }
    }

    /**
     * Obtener todos los emails suscritos (para exportar)
     */
        ...
        try {
            ...
            snapshot.docs.forEach(doc => {
                ...
                emails.push({
                    ...
                    subscribedDate: data.newsletterDate
                });
            });
            
            return emails;
        } catch (error) {
            console.error('Error obteniendo emails newsletter:', error);
            return [];
        }
    }
